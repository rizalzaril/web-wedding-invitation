...
// Add a listener for user interaction to start audio playback
window.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("click", () => {
    if (audio.muted) {
      audio.muted = false; // Unmute audio on first interaction
      audio.play().catch((error) => {
...
// Add event listener to the icon for toggling audio
